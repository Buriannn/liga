...
if (isset($_POST)) {
	...
	$tarif = $_POST['tarif'];
        ...
        $pride = new PrideIntegrate('5ede2a94-0638-4432-bb78-4077a61aaa35', '52c49d48-2144-4012-9e7e-a75546bd82ca');
...
//	GETCOURSE
        ...
        $product = '2639757';
    $productname = 'Финальный Аккорд Большой Игры в МЛМ (Платина - Доплата)';
    $suma = 14903;
...
//  GETCOURSE
    ...
    $utm = 'price=997&productname=Предоплата&name='.$name.'&email='.$email.'&phone='.$phone.''.$utm.'';
